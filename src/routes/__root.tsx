    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-xl border border-border bg-secondary px-5 py-2.5 text-sm font-medium">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buy premium AI subscriptions: ChatGPT, Gemini, Midjourney, Ideogram, Recraft and more at unbeatable prices." },
      { name: "author", content: "AIMarket" },
      { property: "og:title", content: "AIMarket — Premium AI Products" },
      { property: "og:description", content: "Premium AI subscriptions and digital products." },
