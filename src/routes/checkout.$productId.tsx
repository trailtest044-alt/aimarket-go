...
function CheckoutPage() {
  ...
  if (isLoading) return <div className="min-h-screen"><SiteHeader /><div className="mx-auto max-w-4xl p-6"><ServerLoader title="Please wait, server loading..." message="Our little AI assistant is preparing checkout." /></div></div>;
